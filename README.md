...
- Creazione e mescolamento di un mazzo di carte
- Pesca delle carte tramite API
- Visualizzazione grafica delle carte
- Calcolo del punteggio del giocatore e del banco
- Verifica delle regole base del Blackjack
- Determinazione del risultato finale (vittoria, sconfitta, pareggio)
...
- **CSS3** – stile e layout
- **JavaScript** – logica di gioco e integrazione API
